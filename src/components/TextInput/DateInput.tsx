...
import {ptColor, style} from 'constants/style';
...
> {
  ...
  static defaultProps = {
    mask: 'DD/MM/YYYY',
    onChange: () => {},
    activeColor: ptColor.appColor,
    validate: true,
  };
  constructor(props: DateInputProps) {
    super(props);
    let index = -1;
    const mask = props.mask.split('').map((v: any) => {
